...
export const createShape = (type: TShapeType, customProps: Record<string, any>) => {

    const definition = shapeDefinitions[type] as any; //TODO: later type this shape definitions
